        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ProjectNote = table.Column<string>(type: "nvarchar(max)", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_TaskProjects", x => x.TaskProjectId);
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    TimeEntry = table.Column<DateTime>(type: "datetime2", nullable: true),
                    TimesheetNote = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    TimesheetStatus = table.Column<string>(type: "nvarchar(max)", nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Timesheets_TaskProjects_TaskProjectId",
                        column: x => x.TaskProjectId,
                        principalTable: "TaskProjects",
                        principalColumn: "TaskProjectId");
                    table.ForeignKey(
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Timesheets_TaskProjectId",
                table: "Timesheets",
